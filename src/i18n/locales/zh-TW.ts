...
export const zhTW: TranslationMessages = {
  ...
  "pwa.offline.shellReady": "目前處於離線模式，快取介面與常見格式仍可使用。",
  "pwa.offline.warming":
    "目前處於離線模式，快取介面已就緒。進階格式需要重新連線完成一次背景預熱。",
  "pwa.offline.fullReady": "目前處於離線模式，完整快取的處理能力仍可使用。",
  "pwa.offline.warmupFailed":
    "目前處於離線模式，快取介面已就緒，但進階格式仍需先完成一次線上預熱。",
  "pwa.warmup.failed":
    "背景離線延伸資源準備失敗。下次連線造訪時會再次嘗試準備進階格式所需資源。",
  ...
  "settings.resolution.lockAspectRatio": "鎖定長寬比",
  ...
  "settings.presets.diff.quality": "品質: {value}",
  ...
  "error.heic.offlineWarmupRequired":
    "這個 HEIC/HEIF 檔案需要先完成一次線上預熱，之後才能離線處理。請重新連線一次，等待離線延伸資源準備完成後再試一次。",
  ...
  "error.processing.tooManyFrames":
    "此動圖的影格數過多，無法安全處理。請改用較短的動圖，或改為輸出靜態首幀。",
  "error.processing.animationTooLarge":
    "此動圖所需記憶體過大，無法安全處理。請選擇更小的預設/解析度，或改為輸出靜態首幀。",
  "error.processing.animatedCodecUnavailable":
    "目前環境不支援動圖處理。請改用靜態輸出格式。",
