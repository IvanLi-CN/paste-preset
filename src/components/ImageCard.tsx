...
export function ImageCard(props: ImageCardProps) {
  const { title, image, highlighted, overlay, rotationDeg = 0 } = props;
  ...
  // Rotating 90 degrees flips the bounding box width/height; this scale keeps
  // the rotated image fitting in the same container.
  const rotationScale =
    isQuarterTurn && image.width > 0 && image.height > 0
